...
In this course, we used the general JavaScript coding writing conventions and guides. Coding conventions are style guidelines for programming which are developed by an individual, a team or a company.
...
In this course we follow the regular JavaScript convention but I added also my preference of writing. 
...
```js
// arrays
const names = ['Ram', 'Mathias', 'Elias', 'Brook']
...
We coverer many types of loops in this course. The regular for loop, while loop, do while loop, for of loop, forEach loop and for in loop.
...
const names = ['Ram', 'Hari', 'Gopal', 'Shyam']
...
#### Conditional
 ...
 We say if, if else, if else if else, switch and ternary operators in previous topics.
