...
<div>
<h2>Sankalpa Group of Engineering</h2>

<p>Sankalpa Group of Engineering offer classes for all Civil Engineering courses and IT solutions, along with expert services in design, construction, and software. 
<br/>
<strong>Build your future with Sankalpa Engineering.</strong>
</p>
...
<div align="center">
  <a href="https://ref.wisprflow.ai/MPMzRGE" target="_blank" rel="noopener noreferrer">
    <picture>
      <source media="(prefers-color-scheme: dark)" srcset="https://scontent.fktm21-2.fna.fbcdn.net/v/t39.30808-6/500634856_122147825630428506_1160531142789222263_n.jpg?_nc_cat=107&ccb=1-7&_nc_sid=cc71e4&_nc_ohc=OPCWojIwIsQQ7kNvwEusvrQ&_nc_oc=AdlWsFIr7dJiPcya5Brv8yzjp_AADn7uJcRT2lmEdsIh3xZqZXefJIkbe_796Od4Y9ey8JRJRRxT3feTTWdlnsT_&_nc_zt=23&_nc_ht=scontent.fktm21-2.fna&_nc_gid=-ZNIaZxUSiZZ-9bXXsfjIg&oh=00_AfmJFJ8HPjyhu1yMFfpBmZIIaRl-eVyn23dp7d2ZbPrmbw&oe=695A8E4E" />
      <img src="https://scontent.fktm21-2.fna.fbcdn.net/v/t39.30808-6/500634856_122147825630428506_1160531142789222263_n.jpg?_nc_cat=107&ccb=1-7&_nc_sid=cc71e4&_nc_ohc=OPCWojIwIsQQ7kNvwEusvrQ&_nc_oc=AdlWsFIr7dJiPcya5Brv8yzjp_AADn7uJcRT2lmEdsIh3xZqZXefJIkbe_796Od4Y9ey8JRJRRxT3feTTWdlnsT_&_nc_zt=23&_nc_ht=scontent.fktm21-2.fna&_nc_gid=-ZNIaZxUSiZZ-9bXXsfjIg&oh=00_AfmJFJ8HPjyhu1yMFfpBmZIIaRl-eVyn23dp7d2ZbPrmbw&oe=695A8E4E"
           alt="Sankalpa Group of Engineering"
           title="Sankalpa Group of Engineering" />
    </picture>
  </a>
</div>
...
<div align="center">
  <h1> 31 Days Of JavaScript: Introduction</h1>
  <a class="header-badge" target="_blank" href="https://www.linkedin.com/in/rahul-shah63/">
  <img src="https://img.shields.io/badge/style--5eba00.svg?label=LinkedIn&logo=linkedin&style=social">
  </a>

<sub>Tutor:
<a href="https://www.linkedin.com/in/rahul-shah63/" target="_blank">Er. Rahul Shah</a><br>
...
![Thirty Days Of JavaScript](./images/banners/day_1_1.png)
...
**Congratulations** on deciding to participate in JavaScript programming training provided by **Sankalpa Group of Engineering**. In this training, you will learn everything you need to be a JavaScript programmer, and in general, the whole concept of programming. In the end of the training, you will get a completion certificate.

**This training program** is a guide for both beginners and advanced JavaScript developers. Welcome to JavaScript World. JavaScript is the language of the web. I enjoy using and teaching JavaScript and I hope you will do so too.

In this step by step JavaScript training, you will learn JavaScript, the most popular programming language in the history of mankind.
...
No prior knowledge of programming is required to follow this training. You need only:
...
We can write any JavaScript code on the Google console or any browser console. However, for this training, we only focus on Google Chrome console. Open the console using:
...
It is possible to write JavaScript code on Google Chrome console can directly without the **_`console.log()`_** function. However, it is included in this introduction because most of this training would be taking place in a text editor where the usage of the function would be mandatory. You can play around directly with instructions on the console.
...
We can write our codes on the browser console, but it won't be for bigger projects. In a real working environment, developers use different code editors to write their codes. In this 30 days of JavaScript training, we will be using Visual Studio Code.
...
```js
console.log(typeof 'tutorial') // string
...
// let firstName = 'Ram'; single line comment
// let lastName = 'Khadka'; single line comment
```
...
let firstName = 'Ram' // first name of a person
let lastName = 'Khadka' // last name of a person
let country = 'Nepal' // country
let city = 'Kathmandu' // capital city
...
```sh
Ram Khadka Nepal Kathmandu 25 true
```
...
let name = 'Ram', job = 'teacher', live = 'Nepal'
...
🌕 You are amazing! You have just completed day 1 training and you are on your way to greatness. Now do some exercises for your brain and muscle.
