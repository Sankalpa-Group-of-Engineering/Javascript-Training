...
```js
  const names = ['Ram', 'Shyam', 'Hari', 'Gopal']
...
```js
const names = [undefined, 'Shyam', 'Hari'] // null won't work here
let [
  firstPerson = 'Ram',
  secondPerson,
  thirdPerson,
...
console.log(getPersonInfo(person))
/*
Ram Karki lives in Nepal. He is 250 years old. He is an teacher. He teaches HTML, CSS, JavaScript, React, Redux, Node, MongoDB, Python and D3.js. He speaks Nepali and a little bit of English.
*/
```
...
```sh
{name: "Ram", title: "Programmer", country: "Nepal", city: "Kathmandu"}
```
...
```sh
{name: "Ram", title: "instructor", country: "Nepal", city: "Kathmandu"}
```
