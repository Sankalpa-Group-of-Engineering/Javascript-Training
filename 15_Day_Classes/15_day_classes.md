...
const person1 = new Person('Ram', 'Khadka')

console.log(person1)
```

```sh
Person {firstName: "Ram", lastName: "Khadka"}
```
...
const person1 = new Person('Ram', 'Khadka')
const person2 = new Person('Hari', 'Basnet')
const person3 = new Person('Shyam', 'Khadka')
...
```sh
Person {firstName: "Ram", lastName: "Khadka"}
Person {firstName: "Hari", lastName: "Basnet"}
Person {firstName: "Shyam", lastName: "Khadka"}
```

Using the class Person we created three persons object. As you can see our class donot have many properties let us add more properties to the class.
...
const person1 = new Person('Ram', 'Khadka', 25, 'Nepal', 'Kathmandu')

console.log(person1)
```

```sh
Person {firstName: "Ram", lastName: "Khadka", age: 25, country: "Nepal", city: "Kathmandu"}
```
...
const person2 = new Person('Hari', 'Basnet', 28, 'Nepal', 'Espoo')
...
```sh
Person {firstName: "Ram", lastName: "Khadka", age: 250, country: "Nepal", city: "Kathmandu"}
Person {firstName: "Hari", lastName: "Basnet", age: 28, country: "Nepal", city: "Espoo"}
```
...
const person1 = new Person('Ram', 'Khadka', 250, 'Nepal', 'Kathmandu')
const person2 = new Person('Hari', 'Basnet', 28, 'Nepal', 'Espoo')
...
["Planning", "Managing", "Organizing"]
[]
Ram Khadka is 25. He lives Kathmandu, Nepal. He knows HTML, CSS and JavaScript
Hari Basnet is 28. He lives Espoo, Nepal. He knows Planning, Managing and Organizing
...
const s1 = new Student('Ram', 'Khadka', 'Nepal', 250, 'Kathmandu')
console.log(s1)
...
```sh
Student {firstName: "Ram", lastName: "Khadka", age: "Nepal", country: 250, city: "Kathmandu", …}
I am a child of the person class
Ram Khadka
Student {firstName: "Ram", lastName: "Khadka", age: "Nepal", country: 250, city: "Kathmandu", …}
Ram Khadka is Nepal. He lives Kathmandu, 250.
```
...
const s2 = new Student('Hari', 'Basnet', 28, 'Nepal', 'Kathmandu', 'Female')
s1.setScore = 1
s1.setSkill = 'HTML'
s1.setSkill = 'CSS'
...
```sh
Student {firstName: "Ram", lastName: "Khadka", age: 25, country: "Nepal", city: "Kathmandu", …}
Student {firstName: "Hari", lastName: "Basnet", age: 28, country: "Nepal", city: "Kathmandu", …}
I am a child of the person class
Ram Khadka
Student {firstName: "Ram", lastName: "Khadka", age: 25, country: "Nepal", city: "Kathmandu", …}
Ram Khadka is 25. He lives in Kathmandu, Nepal. He knows HTML, CSS and JavaScript
I am a child of the person class
Hari Basnet
Student {firstName: "Hari", lastName: "Basnet", age: 28, country: "Nepal", city: "Kathmandu", …}
Hari Basnet is 28. She lives in Kathmandu, Nepal. He knows Planning, Managing and Organizing
```
