...
```sh
Ram Khadka. I am 250. I live in Nepal
```
...
```js
const paragraph = "My name is Ram Khadka. I live in Nepal, Kathmandu.\
...
```sh
I am Ram Khadka. I am 250. I live in Nepal.
I am Ram Khadka. I live in Kathmandu, Nepal. I am a teacher. I teach JavaScript.
```
...
console.log(firstName.toUpperCase())  //  RAM
...
console.log(firstName.toLowerCase())  // ram
...
console.log(firstName.split())    // Change to an array - > ["Ram"]
console.log(firstName.split(''))  // Split to an array at each letter ->  ["R", "a", "m"]
...
console.log(country.includes('pal'))    // true
console.log(country.includes('Pal'))    // false
```
...
let firstName = 'Ram'      // string
let lastName = 'Khadka'        // string
