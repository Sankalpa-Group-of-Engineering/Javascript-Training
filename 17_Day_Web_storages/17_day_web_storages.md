...
```js
localStorage.setItem('firstName', 'Ram') // since the value is string we do not stringify it
console.log(localStorage)
```

```sh
Storage {firstName: 'Ram', length: 1}
```
...
```sh
 Storage {age: '200', firstName: 'Ram', length: 2}
```
...
```sh
Storage {age: '200', firstName: 'Ram', skills: 'HTML,CSS,JS,React', length: 3}
```
