...
```sh
[{name: 'Ram', score: 95}, { name: 'Shyam', score: 98 },{name: 'Ramesh', score: 85},{name: 'Ravi', score: 100}]
```
...
```js
const names = ['Ramesh', 'Hari', 'Ram', 'Shiv']
...
const result = names.findIndex((name) => name.length > 5)
